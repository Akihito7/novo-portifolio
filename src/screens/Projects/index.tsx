    ...
    const works = [
        {
            ...
            Name: "AkFinances.",
            description: "Controle suas finanças com facilidade em poucos cliques! Gerencie gastos e ganhos de forma simples, com gráficos detalhados para uma visão clara. Você no comando do seu dinheiro!",
